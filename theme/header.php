...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-LPNMCP1N3Z"></script>
<script>
	window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-LPNMCP1N3Z');
</script>
