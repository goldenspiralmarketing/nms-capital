...
<?php $team_listing_id = get_field( 'team_listing', 'option' ); ?>
...
<?php get_header(); ?>
	...
	<main role="main">
		<?php if ( have_rows('page_modules', $team_listing_id) ) : ?>
			<?php set_query_var( 'flex_counter', 0 ); ?>
			<?php set_query_var( 'lazy_load_trigger', 3 ); ?>
						<?php while ( have_rows('page_modules', $team_listing_id) ) : the_row(); ?>
